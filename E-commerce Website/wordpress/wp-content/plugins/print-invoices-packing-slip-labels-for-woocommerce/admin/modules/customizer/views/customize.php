...
.wf_inptgrp input[type="text"]{ float:left; width:80%; border-top-right-radius:0; border-bottom-right-radius:0; }
.wf_inptgrp .addonblock{ float:left; border:1px solid #ced4da; width:20%; border-radius:5px; border-top-left-radius:0; border-bottom-left-radius:0; background-color:#e9ecef; color:#4c535a; text-align:center; height:32px; line-height:28px; margin-left:-2px; margin-top:1px;}
...
<div class="wf_cst_headbar">
	<div style="float:left;">
		...
		<a class="wf_pklist_new_template" style="float:left; width:100%; padding-left:15px; cursor:pointer;"><?php _e('Create new template','wf-woocommerce-packing-list');?></a>
	</div> 	
	<div style="float:right; margin-top:22px; margin-right:-15px;">			
		...
		<button type="button" name="" class="button-secondary wf_customizer_drp_menu" style="height: 28px;">
...
<div class="wf_customizer_main">	
	...
	<div class="wf_customizer_tabhead_main">
		<div class="wf_customizer_tabhead_inner">
			<div class="wf_cst_tabhead_vis wf_cst_tabhead" data-target="wf_customize_vis_container"><?php _e('Visual','wf-woocommerce-packing-list');?></div>
			<div class="wf_cst_tabhead_code wf_cst_tabhead" data-target="wf_customize_code_container"><?php _e('Code','wf-woocommerce-packing-list');?></div>
		</div>
	</div>
	<?php
	}else
	...
	<div class="wf_customizer_tabhead_main">
		<div class="wf_customizer_tabhead_inner">
			<div class="wf_cst_tabhead_vis wf_cst_tabhead " data-target="wf_customize_vis_container"><?php _e('Visual','wf-woocommerce-packing-list');?></div>
			<div class="wf_cst_tabhead_code wf_cst_tabhead" data-target="wf_customize_vis_container" style="opacity:.5; cursor:not-allowed;"><?php _e('Code','wf-woocommerce-packing-list');?> <span style="color:red;">(<?php _e('Pro version','wf-woocommerce-packing-list');?>)</span></div>
		</div>
	</div>
	<?php
	}
