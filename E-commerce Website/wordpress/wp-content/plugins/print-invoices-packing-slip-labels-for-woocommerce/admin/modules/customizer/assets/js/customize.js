	...
	pklist_customize=
	{
		...
		loadMyThemes:function(template_action,template_id)
		{
			var data = {
	            ...
	            action: "wfpklist_customizer_my_templates",
		...
		saveTheme:function()
		{
			var data = {
	            _wpnonce:wf_woocommerce_packing_list_customizer.nonces.main,
	            action: "wfpklist_customizer_save_theme",
	            template_type:wf_woocommerce_packing_list_customizer.template_type,
		...
		updateFromCodeView:function()
		{
			var data = {
	            _wpnonce:wf_woocommerce_packing_list_customizer.nonces.main,
	            action: "wfpklist_customizer_update_from_codeview",
	            template_type:wf_woocommerce_packing_list_customizer.template_type,
	            codeview_html:pklist_customize.getCodeViewHtml(),
	        };
	        this.setLoader();
		...
		loadTemplateData:function()
		{
			var data = {
	            _wpnonce:wf_woocommerce_packing_list_customizer.nonces.main,
	            action: "wfpklist_customizer_get_template_data",
	            template_type:wf_woocommerce_packing_list_customizer.template_type,
	            template_id:pklist_customize.template_id,
	            def_template:pklist_customize.template_base,
	        };
					...
					}else
					{
						...
						if(elm.is(':checked'))
						{
							...
							if(nodeName=='th' || nodeName=='td')
							{
								...
								tgt_elm.parents('table').find('td:nth-child('+ind+'),th:nth-child('+ind+')').show();
							}else
							{
						...
						}else
						{
							...
							if(nodeName=='th' || nodeName=='td')
							{
								...
								var ind=tgt_elm.index()+1;
								tgt_elm.parents('table').find('td:nth-child('+ind+'),th:nth-child('+ind+')').hide();
							}else
							{
		...
		{
			$('#wfte_code').val(htmlDom.html());
			if(pklist_customize.enable_code_view)
			{
				wf_code_editor.getDoc().setValue(htmlDom.html());
			}
		},
