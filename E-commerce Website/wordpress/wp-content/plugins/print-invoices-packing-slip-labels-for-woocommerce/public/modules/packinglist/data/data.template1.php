...
.wfte_order_number{ font-size:16px; font-weight:bold; }
.wfte_order_date{ font-size:16px;}
...
.wfte_product_table_head th{ border:solid 1px #000; height:36px; padding:0px; color:inherit; font-size:.75rem; text-align:center; line-height:10px;}
